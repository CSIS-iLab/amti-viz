...
const URL = `https://content-sheets.googleapis.com/v4/spreadsheets/1BfIDHH5pwXrk-qDdAcBDL_vhClfl3xFRHymJBjl_Z-I/values/2024?key=AIzaSyBXuQRRw4K4W8E4eGHoSFUSrK-ZwpD4Zz4&majorDimension=ROWS`;
...
async function drawChart() {
  ...
  let options = {
    colors: ["#58a897", "#83badc", "#3b75bb", "#c79bd3", "#ca6d92", "#00BE88"],
    timeline: {
      rowLabelStyle: {
        fontName: "Arial",
        fontSize: 14,
